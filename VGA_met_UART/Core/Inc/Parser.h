...
static char commands_check[][SIZE_OF_COMMANDS] = {"lijn", "rechthoek", "tekst", "bitmap", "clearscherm", "wacht", "herhaal","cirkel" };
...
static unsigned char message_col[SIZE_OF_COMMANDS] = {VGA_COL_BLACK, VGA_COL_BLUE, VGA_COL_LIGHTBLUE, VGA_COL_GREEN, VGA_COL_LIGHTGREEN, VGA_COL_CYAN, VGA_COL_LIGHTCYAN, VGA_COL_RED, VGA_COL_LIGHTRED, VGA_COL_MAGENTA, VGA_COL_LIGHTMAGENTA, VGA_COL_BROWN, VGA_COL_YELLOW, VGA_COL_GRAY, VGA_COL_WHITE};
